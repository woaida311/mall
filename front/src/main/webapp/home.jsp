...
<div class="hmtop">
    ...
    <div class="nav white">
        ...
        <div class="search-bar pr">
            ...
            <form action="showByKeyWord" method="post">
...
<div class="banner">
    ...
    <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
        <ul class="am-slides">
            <li class="banner1"><a href="showByPid?id=1"><img src="static/images/ad1.jpg" /></a></li>
            <li class="banner2"><a href="showByPid?id=2"><img src="static/images/ad2.jpg" /></a></li>
            <li class="banner3"><a href="showByPid?id=3"><img src="static/images/ad3.jpg" /></a></li>
            <li class="banner4"><a href="showByPid?id=4"><img src="static/images/ad4.jpg" /></a></li>
                                                ...
                                                <div class="sort-side">
                                                    <dl class="dl-sort">
                                                        ...
                                                        <c:forEach  items="${cb.brands}" var="brand">
                                                            <dd><a href="showByBid?bid=${brand.id}" title="${brand.name}"><span>${brand.name}</span></a></dd>
                                                        </c:forEach>
                                                    </dl>
                                            </div>
                                        </div>
