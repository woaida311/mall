...
<%@ page import="com.hwua.common.po.Product" %>
<%@ page import="com.hwua.common.po.Member" %>
<%@ page import="com.hwua.common.po.Address" %>
...
<div class="am-container header">
        ...
        <div class="topMessage">
            <div class="menu-hd">
                <%
                    ...
                    if(member==null){
                %>
                <a href="${ctx}/login.jsp" target="_top" class="h">亲，请登录</a>
    ...
    <ul class="message-r">
        ...
        <div class="topMessage mini-cart">
            <div class="menu-hd"><a id="mc-menu-hd" href="queryCart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"></strong></a></div>
        </div>
...
<div class="pay">
    <div class="pay-opt">
        <a href="${ctx}/home.jsp"><span class="am-icon-home am-icon-fw">首页</span></a>
        <a href="shoucang.jsp"><span class="am-icon-heart am-icon-fw">收藏</span></a>

    </div>
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login">
            <a id="LikBuy" title="点此按钮立即购买" href="dopay">立即购买</a>
        </div>
    </li>
    <li>
...
<c:forEach items="${requestScope.map}" var="m">
                <li class="first">
                    <div class="p-img">
                        <a  href="goods?goodsId=${m.id}"> <img class="" src="${m.img_src}"> </a>
                    </div>
                    <div class="p-name"><a href="goods?id=${m.id}">
                        ${m.name}
                    </a>
                    </div>
                    <div class="p-price"><strong>${m.price}</strong></div>
                </li>
</c:forEach>
            </ul>
        </div>
