            ...
            <div class="am-u-sm-12 am-u-md-12">
                <div class="search-content">
                    ...
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                        <c:forEach items="${requestScope.products}" var="ps">
                        <li>
                            <div class="i-pic limit">
                                <a href="showByPid?id=${ps.id}&&mid=${sessionScope.member.mid}"><img src=${ps.src_img}/></a>
                                <p class="title fl">${ps.comments}</p>
                                <p class="price fl">
                                    <b>¥</b>
...
<%--<script>
    window.jQuery || document.write('<script src="${ctx}/static/js/jquery-1.9.min.js"><\/script>');
</script>--%>
